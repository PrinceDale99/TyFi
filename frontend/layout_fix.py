...
# I will find the start of the JSX return statement
start_idx = text.find('return (')

# I will define the new JSX return block
new_jsx = """return (
    <div className="w-full max-w-7xl mx-auto space-y-6 lg:space-y-8 pb-32 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <ParallaxCard className="lg:col-span-8 p-6 flex flex-col">
          <div className="flex items-center justify-between mb-6">
        ...
        <ParallaxCard className="lg:col-span-4 p-6">
