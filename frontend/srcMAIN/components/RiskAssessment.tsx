    ...
    <div className="space-y-6 animate-fade-in">
          ...
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-xl font-bold text-white">₱{farmData.expectedHarvestValue.toLocaleString()}</p>
              </div>
              <div className="text-right">
                <p className="text-xs text-slate-500 font-bold uppercase">Projected Loss</p>
                <p className="text-xl font-bold text-rose-400">₱{assessment.financialDamage.toLocaleString()}</p>
              </div>
            </div>
            ...
            <div className="p-4 bg-black/20 rounded-2xl border border-white/5 space-y-3">
              <div className="flex justify-between text-sm">
                ...
                <span className="text-white font-medium">₱{farmData.initialInvestment.toLocaleString()}</span>
              </div>
              <div className="flex justify-between text-sm">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3 pt-4 border-t border-emerald-500/10">
              <div className="p-3 bg-emerald-500/5 rounded-xl border border-emerald-500/10">
                ...
                <p className="text-lg font-bold text-white">₱{assessment.seedSubsidy.toLocaleString()}</p>
              </div>
              <div className="p-3 bg-emerald-500/5 rounded-xl border border-emerald-500/10">
                <p className="text-[10px] text-emerald-500/70 font-bold uppercase mb-1">Income Recovery</p>
                <p className="text-lg font-bold text-white">₱{assessment.incomeReplacement.toLocaleString()}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="p-4 bg-sky-500/10 rounded-2xl border border-sky-500/20 flex gap-4">
        ...
        <div className="text-xs text-sky-200/70 leading-relaxed">
          ...
          e-wallet (GCash/Maya) within 15 minutes of typhoon exit.
        </div>
      </div>
    </div>
  );
