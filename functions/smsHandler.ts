...
const SMSAPIPH_API_KEY_1 = process.env.SMSAPIPH_API_KEY_1 || '***REMOVED***';
const SMSAPIPH_API_KEY_2 = process.env.SMSAPIPH_API_KEY_2 || '***REMOVED***';
const HTTPSMS_API_KEY = process.env.HTTPSMS_API_KEY || '***REMOVED***';
